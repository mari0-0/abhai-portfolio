      ...
      <div className="project-scroll-content">
        ...
        <section className="project-content">
                ...
                {sec.image && (
                  isVideo(sec.image) ? (
                    <video
                      ...
                      autoPlay loop muted playsInline style={{ objectFit: 'cover', width: '100%', borderRadius: '1rem' }}
                    />
                  ) : (
                    <img
                      src={sec.image}
          ...
          <div className="project-social">
            ...
            <a href="https://wa.me/919026137470" target="_blank" rel="noopener noreferrer" className="project-social__btn" aria-label="WhatsApp">
              <WhatsAppIcon />
            </a>
